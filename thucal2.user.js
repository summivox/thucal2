...
(function() {
  var ERR_MSG_LIST, ICAL_EVENT, ICAL_EX, ICAL_FOOTER, ICAL_HEADER, ICAL_WEEK, buildArray, cmp, combine, download, getLrel, getOrigin, getTOffset, get_L, ical, iced, inferYear, parseLabInfo, parseRegLoc, parseTermId, parseTimeStr, parseWeekStr, parse_G, parse_L, period, printTermId, stringify, thucal, __iced_k, __iced_k_noop,
    __slice = [].slice;
...
;
  ...
  getLrel = function(L, origin) {
    var Lrel, x, _i, _len, _results;
    Lrel = [];
    _results = [];
    for (_i = 0, _len = L.length; _i < _len; _i++) {
      x = L[_i];
      _results.push(Lrel[x.ymd.diff(origin, 'days')] = x.items);
    }
    return _results;
  };
  ...
  unsafeWindow.thucal = thucal = new function() {
    ...
    this.make = function() {
      var Gl, Gr, L, Lraw, Lrel, origin, ret, term, termIdP, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
