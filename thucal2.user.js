...
(function() {
  var ERR_MSG_LIST, ICAL_EVENT, ICAL_EX, ICAL_FOOTER, ICAL_HEADER, ICAL_WEEK, buildArray, cmp, combine, download, getOrigin, getTOffset, get_L, ical, iced, inferYear, parseTermId, parseTimeStr, parseWeekStr, parse_G, parse_L, period, stringify, thucal, __iced_k, __iced_k_noop,
    __slice = [].slice;
...
;
  ...
  window.ical = ical = new function() {
      ...
      for (i = _k = 1; _k <= 16; i = _k += 1) {
        if (exclude[i]) {
          ret.push(this.template(ICAL_EX, {
            date: this.timeStr(d1.clone().add(i - 1, 'weeks'), gi.beginT)
          }));
        }
      }
      return ret.join('');
    ...
    this.makeG = function(G, origin) {
      var bin, d1, gi, p, ret, seq, z, _i, _j, _k, _len, _ref,
        _this = this;
      ret = [];
      for (z = _i = 1; _i <= 7; z = _i += 1) {
  ...
  window.stringify = stringify = function(p) {
    var k, v;
    return ((function() {
      var _results;
      _results = [];
  ...
  window.get_L = get_L = function(autocb) {
  ...
  window.download = download = function(cont, name) {
    var b;
    b = new Blob([cont], {
      type: 'text/calendar'
    });
  ...
  window.thucal = thucal = new function() {
    this.init = function() {
      var _this = this;
      this.ui = {};
      $('input[name="export2"]').before("<input type=\"button\" id=\"thucal_button\" value=\"THUCAL: 导出为iCalendar\">");
    ...
    this.make = function() {
      var Gl, Gr, L, Lraw, origin, ret, term, termIdP, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
