...
(function() {
  var ERR_MSG_LIST, ICAL_EVENT, ICAL_EX, ICAL_FOOTER, ICAL_HEADER, ICAL_WEEK, buildArray, cmp, combine, download, getOrigin, getTOffset, get_L, ical, iced, inferYear, parseLabInfo, parseRegLoc, parseTermId, parseTimeStr, parseWeekStr, parse_G, parse_L, period, printTermId, stringify, thucal, __iced_k, __iced_k_noop,
    __slice = [].slice;
